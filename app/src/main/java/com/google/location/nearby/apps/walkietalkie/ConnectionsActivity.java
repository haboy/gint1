...
public abstract class ConnectionsActivity extends AppCompatActivity {
  ...
  /**
   * Transfer progress or completion for a payload. Override to handle FILE transfer completion.
   *
   * @param endpoint The sender or receiver endpoint.
   * @param update The transfer update.
   */
